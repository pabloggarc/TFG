	...
	\section{Redes neuronales artificiales}
		...
		\section{Transformers multimodales}\label{sec:transformers_multimodales}
			...
			\subsection{Clasificación no supervisada}
				...
				\begin{figure}[!h]
					\centering
					\includegraphics[scale = .7]{elbow_ejemplo}
				...
				A modo de resumen de la arquitectura propuesta para la clasificación no supervisada de imágenes, se muestra en la \Cref{fig:esquema_arq} un diagrama que la recoge. 
