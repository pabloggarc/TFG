	...
	\section{Clasificación de imágenes mediante redes convolucionales}
		...
		\subsection{Evaluación de los modelos}
			...
			\subsection{Detección de clases desconocidas}
				...
				Los resultados del entrenamiento del clasificador binario han sido adecuados. Visualizando la matriz de confusión (\Cref{fig:mc_bin}), apenas existen clasificaciones incorrectas. Los valores de la precisión, sensibilidad, y $F_1$ en cada clase son muy positivos. 
