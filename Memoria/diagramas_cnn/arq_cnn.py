...
arch = [
    ...
    to_SoftMax("dense1", 173056 ,"(2.5,0,0)", "(conv3-east)", caption = "Dense"),
    to_connection("pool2", "dense1"),    
    to_SoftMax("softmax", 4 ,"(2.5,0,0)", "(dense1-east)", depth = 10, caption = "Softmax"),
    to_connection("dense1", "softmax"),
    to_end()
